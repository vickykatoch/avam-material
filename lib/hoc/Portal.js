...
var Portal = _wrapComponent('Portal')(function (_Component) {
  ...
  _createClass(Portal, [{
    ...
    value: function _renderOverlay() {
      var overlay = !this.props.children ? null : _react3.default.Children.only(this.props.children);
...
Portal.propTypes = {
  ...
  container: _react2.PropTypes.any,
  lockBody: _react2.PropTypes.bool
};
