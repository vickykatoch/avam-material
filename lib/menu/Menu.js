  ...
  var Menu = _wrapComponent('Menu')((_temp2 = _class = function (_Component) {
    ...
    _createClass(Menu, [{
      ...
      value: function componentWillUnmount() {
        if (this.state.active) _events2.default.removeEventsFromDocument({ click: this.handleDocumentClick });
...
exports.default = (0, _reactCssThemr.themr)(_ComponentIdentifiers.MENU)(Menu);
